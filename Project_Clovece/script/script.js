...
function generateGameboard()
{
    ...
    {
        var count=0;
        if(this.id.includes('yellow')  && playerOnTurn == "yellow")
        {
        for(var i=1;i<=4;i++)
        {
        ...
        if(this.id.includes('red')  && playerOnTurn == "red")
        {
        for(var i=1;i<=4;i++)
        {
        ...
        if(this.id.includes('blue')  && playerOnTurn == "blue")
        {
        for(var i=1;i<=4;i++)
        {
        ...
        if(this.id.includes('green') && playerOnTurn == "green")
        {
        for(var i=1;i<=4;i++)
        {
